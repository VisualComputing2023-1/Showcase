...
We will modelize the terrain thanks to a two dimensional array (matrix n*m), forming a grid. TEvery cell of this matrix represents a point of the terrain. It has certain coordinates (abscisse ?, ordonnée ?, height) and a certain color. Changing these parameters allow us to change the appearance of the terrain.
...
A second idea is to use Perlin noise. This is [definition]
